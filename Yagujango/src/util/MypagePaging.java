...
public class MypagePaging {
	...
	//	pageCount == 5
	//	listCount == 5
	public MypagePaging(int totalCount) {
	...
	//	pageCount == 5
	//	listCount == 5
	public MypagePaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	pageCount == 5
	public MypagePaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public MypagePaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	private void makePaging() {
		if(totalCount == 0)	return; //게시글이 없는 경우 함수 수행 안함
